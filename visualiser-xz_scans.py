...
if __name__ == "__main__":
    ...
    path ="C:/Users/komor/OneDrive - Wojskowa Akademia Techniczna/Pomiary/Ring_lens"
    ...
    for i in range(len(paths)):
        ...
        plt.xlabel('z [mm]')
        plt.ylabel('x [mm]')
        plt.imshow(image[y,:,:], cmap='inferno', aspect = 'auto',extent=[301 - z_stop, 301 - z_start, -72, 72])
